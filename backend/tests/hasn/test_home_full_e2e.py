...
async def test_workbench_briefing_and_apps_full_flow(env) -> None:
    ...
    pref = _data(await c.get(f'{_BASE}/home/pref'))
    ...
    latest = _data(await c.get(f'{_BASE}/home/briefing/latest'))
    ...
    _data(
        await c.post(
            f'{_BASE}/home/briefing/items/fi_social/dismiss',
