...
覆盖（设计 doc 04 §4/§5）：
  ...
  - GET /home/briefing/latest：返回最新文档 / 空态如实（has_briefing=False，不造卡）。
  - POST /home/briefing/items/{item_id}/dismiss：写反馈。
...
from backend.app.home.model.hasn_workbench_briefing import HasnWorkbenchBriefing
...
_LATEST = '/api/v1/hasn/app/home/briefing/latest'
...
async def test_dismiss_records_feedback(env) -> None:
    ...
    data = _data(
        await c.post(
            '/api/v1/hasn/app/home/briefing/items/fi_1/dismiss',
