...
-- 自动生成于: 2026-07-16 22:02:55.997472+08:00
...
BEGIN
    ...
    IF v_parent_id IS NULL THEN
        ...
        VALUES ('', 'Hasn_project', '/hasn_project', 1, 'lucide:folder', 0, 'BasicLayout', NULL, 1, 1, 1, '', 'hasn_project模块', NULL, NOW(), NULL)
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('', 'HasnProject', '/hasn_project/hasn_project', 1, 'lucide:list', 1, '/hasn_project/hasn_project/index', NULL, 1, 1, 1, '', '平台项目（云端权威·业务容器·联邦挂靠聚合门面，doc38）', v_parent_id, NOW(), NULL)
