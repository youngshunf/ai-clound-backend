...
from backend.app.hasn_growth.schema.playbook import (
    CreatePlaybookParam,
    DeletePlaybookParam,
    GetPlaybookDetail,
    UpdatePlaybookParam,
...
@router.get('/{pk}', summary='获取获客打法模板（目标画像 + 触达节奏 + 话术要点），内置 + 自定义详情', dependencies=[DependsJwtAuth], name='admin_get_playbook')
...
@router.get(
    ...
    name='admin_get_playbook_paginated',
)
