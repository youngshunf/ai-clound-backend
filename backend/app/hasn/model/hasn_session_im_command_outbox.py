...
class HasnSessionImCommandOutbox(Base):
    """工作会话结果与应用完成卡的事务 IM 命令队列"""

    __tablename__ = 'hasn_session_im_command_outbox'

    id: Mapped[id_key] = mapped_column(init=False)
    command_id: Mapped[str] = mapped_column(sa.String(40), default='', comment='命令公开标识')
    producer: Mapped[str] = mapped_column(sa.String(40), default='', comment='生产方固定标识 session')
    ...
    causation_id: Mapped[str | None] = mapped_column(sa.String(80), default=None, comment='触发本命令的会话或资源标识')
