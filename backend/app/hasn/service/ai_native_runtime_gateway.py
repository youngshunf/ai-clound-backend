...
class AiNativeRuntimeGateway:
    ...
    def _internal_handlers(self) -> dict[str, Any]:
        ...
        registry: dict[str, Any] = {
            ...
            'creator.account_update': creator_handlers.handle_account_update,
            'creator.account_update_metrics': creator_handlers.handle_account_update_metrics,
            'creator.account_works_upsert': creator_handlers.handle_account_works_upsert,
            'creator.account_works_list': creator_handlers.handle_account_works_list,
            'creator.competitor_log': creator_handlers.handle_competitor_log,
            'creator.competitor_update': creator_handlers.handle_competitor_update,
            'creator.competitor_works_upsert': creator_handlers.handle_competitor_works_upsert,
            'creator.media_add': creator_handlers.handle_media_add,
            'creator.media_list': creator_handlers.handle_media_list,
            'creator.media_update': creator_handlers.handle_media_update,
            'creator.media_delete': creator_handlers.handle_media_delete,
            'creator.draft_create': creator_handlers.handle_draft_create,
            'creator.draft_update': creator_handlers.handle_draft_update,
            'creator.draft_list': creator_handlers.handle_draft_list,
