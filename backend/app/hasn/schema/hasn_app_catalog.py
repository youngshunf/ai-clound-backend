...
class HasnAppCatalogSchemaBase(SchemaBase):
    ...
    icon_asset_uri: str | None = Field(None, description='自定义图标资产 URI（优先于 token），hasn://asset/{id} 或 https')
    ...
    execution_mode: str = Field(description='执行形态 (cloud:云端:blue/embedded_desktop:桌面嵌入:green/local_tool:本地工具:gray)')
