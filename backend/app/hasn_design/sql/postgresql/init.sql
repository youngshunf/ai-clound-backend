...
-- 自动生成于: 2026-06-27 20:29:24.622199+08:00
...
BEGIN
    ...
    IF v_parent_id IS NULL THEN
        ...
        VALUES ('', 'Hasn_design', '/hasn_design', 1, 'lucide:folder', 0, 'BasicLayout', NULL, 1, 1, 1, '', 'hasn_design模块', NULL, NOW(), NULL)
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('', 'HasnDesignProject', '/hasn_design/hasn_design_project', 1, 'lucide:list', 1, '/hasn_design/hasn_design_project/index', NULL, 1, 1, 1, '', '设计项目（矢量设计 design：云端轻登记元数据，源文件本地优先）', v_parent_id, NOW(), NULL)
