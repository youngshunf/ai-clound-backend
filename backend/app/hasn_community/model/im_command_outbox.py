...
class ImCommandOutbox(Base):
    """社区资源写入触发主人知情卡的事务命令队列"""

    __tablename__ = 'im_command_outbox'

    id: Mapped[id_key] = mapped_column(init=False)
    command_id: Mapped[str] = mapped_column(sa.String(40), default='', comment='命令公开标识')
    producer: Mapped[str] = mapped_column(sa.String(40), default='', comment='生产方固定标识 community')
    ...
    causation_id: Mapped[str | None] = mapped_column(sa.String(80), default=None, comment='触发本命令的社区资源标识')
