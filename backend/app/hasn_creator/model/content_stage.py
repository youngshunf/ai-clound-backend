...
class ContentStage(HasnCreatorAppBase):
    ...
    stage: Mapped[str] = mapped_column(sa.String(30), default='', comment='阶段 (research:调研:blue/outline:大纲:cyan/first_draft:初稿:orange/final_draft:终稿:purple/cover:封面:green/storyboard:分镜:teal/voiceover:口播:violet)')
