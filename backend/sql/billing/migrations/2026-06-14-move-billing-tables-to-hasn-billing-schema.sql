-- 迁移：计费 12 张表从 public 搬入独立 PG schema hasn_billing（ADR-15：AI-Native 应用一应用一 schema）。
...
-- 12 张表 = 支付 6（pay_*）+ 订阅积分 6（credit_*/subscription_tier/user_*/model_credit_rate）。
