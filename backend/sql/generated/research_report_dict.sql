-- =====================================================
-- 投研报告（流程 A·产物·同事务登记 hasn_artifacts，05 §3.1.2） 字典数据初始化 SQL
-- 自动生成于: 2026-07-17 05:45:39.315224
-- =====================================================

-- 状态 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('状态', 'hasn_finance_status', '投研报告（流程 A·产物·同事务登记 hasn_artifacts，05 §3.1.2）模块-状态', NOW(), NULL)
