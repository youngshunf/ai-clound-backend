-- =====================================================
-- 自选股（人工维护·非产物·不登记 hasn_artifacts，05 §3.1.1） 字典数据初始化 SQL
-- 自动生成于: 2026-07-17 05:37:28.003249
-- =====================================================

-- 状态 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('状态', 'hasn_finance_status', '自选股（人工维护·非产物·不登记 hasn_artifacts，05 §3.1.1）模块-状态', NOW(), NULL)
