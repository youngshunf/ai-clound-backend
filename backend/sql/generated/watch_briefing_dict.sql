-- =====================================================
-- 盯盘简报（流程 D·产物·同事务登记 hasn_artifacts；流程 D 不属第一版上线门，05 §3.1.7） 字典数据初始化 SQL
-- 自动生成于: 2026-07-17 05:45:41.883130
-- =====================================================

-- 状态 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('状态', 'hasn_finance_status', '盯盘简报（流程 D·产物·同事务登记 hasn_artifacts；流程 D 不属第一版上线门，05 §3.1.7）模块-状态', NOW(), NULL)
