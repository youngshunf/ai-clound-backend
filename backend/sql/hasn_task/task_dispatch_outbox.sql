-- 生成：uv run fba codegen generate --sql-file backend/sql/hasn_task/task_dispatch_outbox.sql --app hasn_task --schema hasn_task --execute
CREATE TABLE "hasn_task"."task_dispatch_outbox" (
...
CREATE INDEX "idx_task_dispatch_outbox_claim"
